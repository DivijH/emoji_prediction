...
for epoch_i in range(0, epochs):
    ...
    if avg_val_loss < best_val_loss:
        torch.save(model.state_dict(), f'roBERTa_{avg_val_loss}')
...
df_stats.to_csv('Models/roBERTa/roBERTa.csv', encoding='utf-8')
...
plt.savefig('Models/roBERTa/roBERTa.png')
plt.close()
...
with open('Models/roBERTa/roBERTa_test.txt', 'w') as f:
